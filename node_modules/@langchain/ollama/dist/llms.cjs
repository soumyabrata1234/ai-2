...
* ```
*/
var Ollama = class extends _langchain_core_language_models_llms.LLM {
	static lc_name() {
		return "Ollama";
	}
	...
	constructor(fields) {
		...
		this.baseUrl = fields?.baseUrl ? fields?.baseUrl.endsWith("/") ? fields?.baseUrl.slice(0, -1) : fields?.baseUrl : (0, _langchain_core_utils_env.getEnvironmentVariable)("OLLAMA_BASE_URL") ?? this.baseUrl;
	...
	async *_streamResponseChunks(prompt, options, runManager) {
		...
		for await (const chunk of stream) {
			...
			} else yield new _langchain_core_outputs.GenerationChunk({
				text: "",
				generationInfo: {
					model: chunk.model,
